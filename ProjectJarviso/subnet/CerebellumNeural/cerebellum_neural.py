...
class CerebellumNeural:
    def __init__(self, input_size, output_size, model_renderer, host='localhost', port=5003):
    ...
    def start_server(self):
        ...
        server.listen(5)
        logging.info(f"[*] CerebellumNeural listening on {self.host}:{self.port}")
        while True:
